 ...
 * Arrow color
 */
$arrow_color = get_field( 'resource_arrow_color', 'option' );
	...
	<div class="slider-group">
		...
		<div class="swiper-container">
			<div class="swiper-wrapper">
				...
				<?php while ( have_rows( 'resource_slides', 'option' ) ) : the_row();
						...
						<div class="wrap">
							...
							<div class="<?php echo $align_right ?> inner-wrap">
								...
								<?php if ( $slide_image['url'] ) : ?>
									<div class="slide-image" style="background-image: url(<?php echo $slide_image['url'] ?>); padding: <?php echo $slide_image['height'] / 4 . 'px' ?> 0;"></div>
								<?php endif; ?>
