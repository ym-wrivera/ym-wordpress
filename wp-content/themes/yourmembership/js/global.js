...
(function($)  {
	...
	function mobileMenu() {
		...
		$(".header .primary-menu > li > a").click(function() {
			if ($(window).width() < 990) {

				$(".header .primary-menu > li > a").not(this).next(".sub-menu").removeClass("open");
	...
	function subMenuTitles() {
		$(".primary-menu > li").each(function() {
			var name = $(this).children("a").text();
			$(this).find(".sub-menu").prepend("<li class='sub-menu-title'>" + name + "</li>");
		})
	}
	...
	function demoFlyout() {
		$("#demo-tab").click(function() {
			$("#request-demo").toggleClass("visible");
		});

		$(".demo-close").click(function() {
			$("#request-demo").removeClass("visible");
		});
	}


	function blogMenuLink() {
		$("#nav_menu-2 .widget-title").wrapInner("<a href='/blog/'></a>")
	}


	function stepGuide() {
		$('#cbp-fbscroller .guide-section').bind('inview', function(event, isInView, visiblePartX, visiblePartY) {
		  if (isInView) {
