...
$slides = get_field( 'case_studies_slides', 'option' );
...
$case_studies_slides = have_rows( 'case_studies_slides', 'option' );
 ...
 * Arrow color
 */
$arrow_color = get_field( 'case_study_arrow_color', 'option' );
$is_arrow_color = $arrow_color ? : '#fff';



if ( have_rows( 'case_studies_slides', 'option' ) ) :
	...
	<div class="slider-group">
		...
		<div class="swiper-container">
			<div class="swiper-wrapper">
				...
				<?php while ( have_rows( 'case_studies_slides', 'option' ) ) : the_row();
