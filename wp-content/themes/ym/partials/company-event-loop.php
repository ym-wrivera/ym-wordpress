<?php
/**
 * Company Events Loop used for Company Events. This
 * file is included in the FacetWP Template GUI for company events.
 *
...
/**
 * Needed for Events shortcodes. Javascript wasn't
 * loading when we needed it when enqueued from the
 * Facetwp template shortcode. Only load js if event
 * shortcodes are in use.
 */
			...
			<article class="event" itemscope="" itemtype="http://schema.org/CreativeWork">
				<?php if ( has_post_thumbnail() ) : ?>
					<figure class="featured-image">
						<a class="entry-image-link" href="<?php echo $event_url ?>"
						   title="<?php the_title_attribute(); ?>"
						   aria-hidden="true" target="<?php echo $link_target ?>">
				...
				<div class="resource-wrap">
					...
					<?php if ( $event_url ) : ?>
						<header>
							<div class="entry-header">
								...
								<?php if ( $booth_num ) : ?>
									<p class="booth-number"><?php echo $booth_num ?></p>
								<?php endif; ?>
							</div>
						</header>
					<?php endif; ?>
					...
					<?php if ( $excerpt ) : ?>
						<div class="entry-content" itemprop="text"><?php echo $excerpt ?></div>
					<?php endif; ?>
					...
					<?php if ( $event_date ) : ?>
						...
						<p class="event-date"><span><?php echo $date_icon ?></span><a
									href="<?php echo $maps_link ?>"
					...
					<?php if ( $event_location ) : ?>
						...
						<p class="event-location"><span><?php echo $pin_icon ?></span><a
									href="<?php echo $maps_link ?>"
									target="<?php echo $link_target ?>"
