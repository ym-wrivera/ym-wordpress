...
if ( ! function_exists( 'gateway_plus_google_fonts' ) ) :
/**
 * Register Default Google fonts
 *
 */
    function gateway_plus_google_fonts() {
        $fonts_url = '';
        $fonts     = array();
        ...
        if ( 'off' !== _x( 'on', 'Quattrocento font: on or off', 'gateway-plus' ) ) {
        ...
        if ( 'off' !== _x( 'on', 'Fanwood Text font: on or off', 'gateway-plus' ) ) {
            $fonts[] = 'Fanwood Text:400,400italic';
        }
        /* translators: To add an additional character subset specific to your language, translate this to 'greek', 'cyrillic', 'devanagari' or 'vietnamese'. Do not translate into your own language. */
        $subset = _x( 'no-subset', 'Add new subset (greek, cyrillic, devanagari, vietnamese)', 'gateway-plus' );
        if ( 'cyrillic' == $subset ) {
