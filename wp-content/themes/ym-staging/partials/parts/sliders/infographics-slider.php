...
$slides = get_field( 'infographics_slides', 'option' );
...
$infographics_slides = have_rows( 'infographics_slides', 'option' );
 ...
 * Arrow color
 */
$arrow_color = get_field( 'infographics_arrow_color', 'option' );
$is_arrow_color = $arrow_color ? : '#fff';



if ( have_rows( 'infographics_slides', 'option' ) ) :
	...
	<div class="slider-group">
		...
		<div class="swiper-container">
			<div class="swiper-wrapper">
				...
				<?php while ( have_rows( 'infographics_slides', 'option' ) ) : the_row();
