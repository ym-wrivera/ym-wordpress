	...
	class acf_field_section_styles extends acf_field {
		...
		*/
		...
		function format_value( $value, $post_id, $field ) {
			...
			// background position valueq
			$value['background_position'] = $value['background_position_1'] . ' ' . $value['background_position_2'];

			// format padding value
			$value['margin'] = !empty( $value['margin_top'] ) ? $value['margin_top'] : '';
			$value['margin'] .= ' ';	// space
			$value['margin'] .= !empty( $value['margin_right'] ) ? $value['margin_right'] : '';
			$value['margin'] .= ' ';	// space
			$value['margin'] .= !empty( $value['margin_bottom'] ) ? $value['margin_bottom'] : '';
			$value['margin'] .= ' ';	// space
			$value['margin'] .= !empty( $value['margin_left'] ) ? $value['margin_left'] : '';
			...
			// format padding value
			$value['padding'] = !empty( $value['padding_top'] ) ? $value['padding_top'] : '';
			$value['padding'] .= ' ';	// space
			$value['padding'] .= !empty( $value['padding_right'] ) ? $value['padding_right'] : '';
			$value['padding'] .= ' ';	// space
			$value['padding'] .= !empty( $value['padding_bottom'] ) ? $value['padding_bottom'] : '';
			$value['padding'] .= ' ';	// space
			$value['padding'] .= !empty( $value['padding_left'] ) ? $value['padding_left'] : '';
