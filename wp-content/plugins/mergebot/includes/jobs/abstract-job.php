...
abstract class Abstract_Job extends Async_Request {
	...
	public function handle_retry_job() {
		...
		delete_transient( $this->identifier . '_error_count' );
	...
	protected function throw_sending_error( $error_code, $error_title, $error_msg, $error_msg_extra = '', $error_data = '' ) {
		$error_count = ( int ) get_transient( $this->identifier . '_error_count' );
		$error_count++;
		set_transient( $this->identifier . '_error_count', $error_count, HOUR_IN_SECONDS );
