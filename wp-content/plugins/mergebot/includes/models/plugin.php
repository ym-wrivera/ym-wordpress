...
class Plugin extends Base_Model {
	...
	public function __construct( array $properties = array() ) {
		...
		$properties['hook_suffix']  = 'tools_page_' . $properties['slug'];
	 ...
	 * @return string
	 */
	public function get_more_info_link( $url ) {
		return sprintf( ' <a target="_blank" href="%s">%s&nbsp;&raquo;</a>', $url, __( 'More&nbsp;info' ) );
	}
	 ...
	 * @return string
	 */
	public function get_more_info_doc_link( $doc ) {
		$url = trailingslashit( $this->app_url ) . 'docs#/' . $doc;

		return $this->get_more_info_link( $url );
	}
