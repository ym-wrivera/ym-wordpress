...
== Upgrade Notice ==
2.2.3 important fix: this fixes duplicated menu buttons if the location setting is not specific enough. If you (like me) used a location such as .site-header .wrap instead of .site-header > .wrap, for example, you may be affected.
